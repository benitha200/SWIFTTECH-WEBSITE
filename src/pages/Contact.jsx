          ...
          <nav className="hidden md:flex space-x-8">
            {navLinks.map((link, index) => (
              <Link 
                key={index}
                to={link.to} 
                className={`text-white font-medium hover:text-sky-400 transition-colors ${link.to === "/contact" ? "text-sky-400" : ""}`}
              >
                {link.label}
              </Link>
            ))}
              ...
              <div className="flex flex-col space-y-2">
                {navLinks.map((link, index) => (
                  <Link 
                    key={index}
                    to={link.to} 
                    className={`text-white hover:text-sky-400 transition-colors py-2 ${link.to === "/contact" ? "text-sky-400 font-medium" : ""}`}
                  >
                    {link.label}
                  </Link>
                ))}
